...
public class Oauth2UserService extends DefaultOAuth2UserService{
	...
	// 소셜 로그인 버튼 클릭 -> 사용자 동의 창 -> 사용자 동의 후 로그인 완료 -> code return -> token 수령 -> token 통한 유저정보 획득 -> loadUser 함수 자동 호출 -> 사용자 정보를 커스터마이징
	@Override
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		// 소셜 카테고리 검증 -> 다른 간편로그인 추가시 else if() 구문으로 추가하면 됨
